...
public class AdminGUI extends JFrame
{
  ...
  public AdminGUI()
  {
    ...
    trackedAppsPanel
        .setLayout(new BoxLayout(trackedAppsPanel, BoxLayout.Y_AXIS));
    ...
    nonTrackedAppsPanel.setLayout(new BoxLayout(nonTrackedAppsPanel,
        BoxLayout.Y_AXIS));
  ...
  private void showUserGUI(int userID)
  {
    ...
    catch( MultipleResultsFoundException | NoResultsFoundException
        | SQLException e )
    {
      e.printStackTrace();
    }
  ...
  static boolean clearStats()
  {
    ...
    if( dialogResult == JOptionPane.YES_OPTION )
    {
      ...
      JOptionPane.showMessageDialog(null,
          "Statistics were successfully cleared", "Success",
