...
public class LoginGUI extends JFrame
{
  ...
  public LoginGUI()
  {
    ...
    containerPanel
        .setLayout(new BoxLayout(containerPanel, BoxLayout.PAGE_AXIS));
    ...
    // Note from Mike: commenting this out and logging in normally hangs the
    // program for me,
  ...
  private void attemptLogin(String username, String password)
  {
    ...
    if( username.equals(Main.settings.MySQL_username)
        && password.equals(Main.settings.MySQL_password) )
    {
      dispose();
    ...
    if( clientFound )
      JOptionPane.showMessageDialog(this, "Welcome " + username,
          "Big Brother Client", JOptionPane.INFORMATION_MESSAGE);
