...
public class App
{
  ...
  public App(int _appID, String _alias, String _window, boolean _windowIsRegex,
      String _process, boolean _processIsRegex, boolean _isActive)
  {
    appID = _appID;
    alias = _alias;
    window = _window;
  ...
  // return a string representation of the app in the format of
  // "*alias* (appID: *appID*)"
  ...
  // print a detailed description of the app to the console (should be only used
  // when Main.settings.debug == true)
  public void print()
  {
    System.out.println(appID + " " + alias + " " + window + " " + window_regex
        + " " + process + " " + process_regex + " " + getPriorityScore());
  ...
  // clears the count representing the number of ticks this app has been in
  // focus
  public void clear()
  {
    count = 0;
  ...
  // Check whether or not this app is a match for a specific windowTitle and
  // processName
