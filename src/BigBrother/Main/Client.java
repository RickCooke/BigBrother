...
public class Client {
    ...
    public Client() {
        ...
        //TODO: actually find the indecies in an efficient way, we shouldn't just gurantee that they're first 
    ...
    private void poll () {
        ...
        if(!idleFlag) {
	        ...
	        //Check for app match
	        //TODO: make this more efficient, it's poorly optimized right now (Rather than looping through all apps). 
    ...
    private void setIdle(boolean _idle) {
    ...
    private void memFlush() throws CountMismatchException {
        ...
        if(otherCount != (Main.memory_flush_interval - totalCount)) {
        	...
        	//throw new CountMismatchException("'Other App' poll count does not match the remainder of time not spent on other apps.");
        }
